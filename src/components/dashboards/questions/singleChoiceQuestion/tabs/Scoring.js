        ...
        <>
            <div className="box">
                ...
                <div className="columns is-vcentered p-0">
                    ...
                    <div className="column is-12-mobile is-1 mb-1 p-1">
                        <input className="input is-fullwidth-mobile" type="number" />
                    </div>
                </div>
                ...
                <div className="columns is-centered p-0">
                    ...
                    <div className="column is-12-mobile is-10 mb-1 p-1">
                        ...
                        <label class="radio has-text-black pt-4">
                            <input type="radio" name="type" />
                            <span className='pl-1'>Points per answer</span>
                            <span className="is-block is-size-7 pt-1">Every selected score will be scored individually. The learner gets points for every correct answer.</span>
                        </label> */}
                    </div>
                </div>
            </div>
            <div className="box ">
                <div className='columns is-vcentered m-0 p-0 is-flex-mobile'>
                    ...
                    <div className='column is-5 is-6-mobile m-0'>
