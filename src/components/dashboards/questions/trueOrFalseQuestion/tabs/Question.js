            ...
            <div className="box">
                <div className="columns is-vcentered p-0">
                    ...
                    <div className="column is-12-mobile is-4 mb-1 p-1">
                        <input className="input is-fullwidth-mobile" type="text" defaultValue="True or False Question" placeholder="Enter title" />
                    </div>
                </div>
                ...
                <div className="columns is-centered p-0">
                    ...
                    <div className="column is-12-mobile is-10 mb-1 p-1">
                        ...
                        <div className="field">
                            ...
                            <label htmlFor="exampleRadioInline1">Single Choice</label>
                        </div>
                        <div className="field">
                            <input className="is-checkradio" id="exampleRadioInline2" type="radio" name="exampleRadioInline" />
                            <label htmlFor="exampleRadioInline2">Multiple Choice</label>
                        </div>
                    </div>
                </div>
                <div className="columns p-0">
