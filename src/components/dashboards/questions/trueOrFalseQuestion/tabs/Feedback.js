                            ...
                            <div className="columns is-vcentered p-0">
                                ...
                                <div className="column is-12-mobile is-9 mb-1 p-1">
                                    ...
                                    {/* <div>
                                        ...
                                        <div className="select is-normal ">
                                            <select className="is-inline mx-1">
                                                <option>&#61;</option>
                                                <option>&#62;</option>
                                                <option>&#8805;</option>
                                                <option selected>&#60;</option>
                                        ...
                                        <div className="is-inline">
                                            <input className="input is-inline" type="number" defaultValue="4" />
                                            <span className="icon is-size-5 m-1 is-clickable"><i className="fas fa-circle-plus" aria-hidden="true"></i></span>
                                        </div>
                                    </div> */}
                                </div>
                            </div>
